  ...
  ),
  {
    variants: {
      variant: {
        ...
        destructive: cn('bg-destructive active:bg-destructive/90 shadow-sm shadow-black/5', Platform.select({ web: 'hover:bg-destructive/90 focus-visible:ring-destructive/20' })),
...
const buttonTextVariants = cva('text-sm font-medium', {
  variants: {
    variant: {
      ...
      outline: cn('text-foreground group-active:text-accent-foreground', Platform.select({ web: 'group-hover:text-accent-foreground' })),
